 ...
 */
final class Version20251105150959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE access_tokens (id VARCHAR(255) NOT NULL, user_id UUID DEFAULT NULL, client_id VARCHAR(255) DEFAULT NULL, scopes TEXT NOT NULL, revoked BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN access_tokens.user_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN access_tokens.scopes IS \'(DC2Type:simple_array)\'');
        $this->addSql('CREATE TABLE clients (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, secret VARCHAR(255) NOT NULL, redirect VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, roles JSON NOT NULL, requires_verification BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE refresh_tokens (id VARCHAR(255) NOT NULL, access_token_id VARCHAR(255) DEFAULT NULL, revoked BOOLEAN NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE access_tokens ADD CONSTRAINT FK_58D184BC19EB6921 FOREIGN KEY (client_id) REFERENCES clients (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE refresh_tokens ADD CONSTRAINT FK_9BACE7E12CCB2688 FOREIGN KEY (access_token_id) REFERENCES access_tokens (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_tokens DROP CONSTRAINT FK_58D184BC19EB6921');
        ...
        $this->addSql('ALTER TABLE refresh_tokens DROP CONSTRAINT FK_9BACE7E12CCB2688');
