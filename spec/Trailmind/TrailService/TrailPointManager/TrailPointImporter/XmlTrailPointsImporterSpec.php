...
use Trailmind\TrailService\TrailPointManager\TrailPointImporter\XmlTrailPointsImporter;

class XmlTrailPointsImporterSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType(XmlTrailPointsImporter::class);
    }
    
    function it_should_be_a_trail_points_importer()
    {
        $this->shouldHaveType(TrailPointsImporter::class);
    }
    
    function it_should_support_an_xml_file()
    {
        $file = $this->getFile();
        $this->supportsFile($file)->shouldReturn(true);
    }
    
    function it_should_not_support_a_non_xml_file()
    {
        $this->supportsFile('not an xml file')->shouldReturn(false);
    }
    ...
    private function getFile(): SimpleXMLElement
    {
